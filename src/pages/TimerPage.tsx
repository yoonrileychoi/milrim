    ...
    <div className="fade-in" style={{
      ...
      <div style={{ width: '100%', maxWidth: 460, display: 'flex', flexDirection: 'column', height: '100%', padding: '22px 24px 40px' }}>
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
          <div style={{ fontSize: 12, color: '#9a9482', fontWeight: 600 }}>데이터베이스 시스템공학 A+</div>
          <div style={{ fontSize: 18, fontWeight: 700, color: '#2B2A26', marginTop: 6 }}>뷰와 트리거 정리 15p</div>
          <div style={{ position: 'relative', width: 250, height: 250, margin: '30px 0' }}>
            ...
            <div style={{ position: 'absolute', inset: 0, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
              ...
              <div style={{ fontSize: 13, color: '#9a9482', marginTop: 4 }}>집중하는 중</div>
            </div>
          </div>
        </div>
        ...
        <div style={{ display: 'flex', gap: 11 }}>
          <button
            onClick={() => { setRunning(false); navigate('/rest') }}
          ...
          >
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10, marginTop: 22 }}>
              <button
                ...
                style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 7, border: 'none', background: '#2E5A3A', color: '#fff', fontSize: 15, fontWeight: 700, padding: 15, borderRadius: 14, fontFamily: 'var(--font)', cursor: 'pointer' }}
              >
              ...
              <button
                ...
                style={{ border: '1px solid #E2DCCB', background: '#fff', color: '#6B6757', fontSize: 15, fontWeight: 600, padding: 15, borderRadius: 14, fontFamily: 'var(--font)', cursor: 'pointer' }}
              >
                아직 다 못 했어요
              </button>
              <button
